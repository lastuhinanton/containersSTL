...
namespace s21 {
    ...
    template <class value_type>
    typename VectorConstIterator<value_type>::pointer VectorConstIterator<value_type>::operator&() const { return ptr_; }
    ...
    template <class value_type>
    bool VectorConstIterator<value_type>::operator==(VectorConstIterator n) { return ptr_ == n.ptr_; }
